...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         vbf_AK4_j1_pt;

   Float_t         vbf_AK4_j1_eta;

   Float_t         vbf_AK4_j1_phi;

   Float_t         vbf_AK4_j1_e;

   Float_t         vbf_AK4_j1_bDiscriminatorCSV;

   Float_t         vbf_AK4_j2_pt;

   Float_t         vbf_AK4_j2_eta;

   Float_t         vbf_AK4_j2_phi;

   Float_t         vbf_AK4_j2_e;

   Float_t         vbf_AK4_j2_bDiscriminatorCSV;

   Float_t         vbf_AK4_jj_pt;

   Float_t         vbf_AK4_jj_eta;

   Float_t         vbf_AK4_jj_phi;

   Float_t         vbf_AK4_jj_m;

   Float_t         vbf_AK4_jj_DeltaEta;

   Float_t         Wjets_AK4_j1_pt;

   Float_t         Wjets_AK4_j1_eta;

   Float_t         Wjets_AK4_j1_phi;

   Float_t         Wjets_AK4_j1_e;

   Float_t         Wjets_AK4_j1_bDiscriminatorCSV;

   Float_t         Wjets_AK4_j2_pt;

   Float_t         Wjets_AK4_j2_eta;

   Float_t         Wjets_AK4_j2_phi;

   Float_t         Wjets_AK4_j2_e;

   Float_t         Wjets_AK4_j2_bDiscriminatorCSV;

   Float_t         Wjets_AK4_jj_pt;

   Float_t         Wjets_AK4_jj_eta;

   Float_t         Wjets_AK4_jj_phi;

   Float_t         Wjets_AK4_jj_m;

   Float_t         Wjets_AK4_jj_e;
   ...
   TBranch        *b_vbf_AK4_j1_pt;   //!

   TBranch        *b_vbf_AK4_j1_eta;   //!

   TBranch        *b_vbf_AK4_j1_phi;   //!

   TBranch        *b_vbf_AK4_j1_e;   //!

   TBranch        *b_vbf_AK4_j1_bDiscriminatorCSV;   //!

   TBranch        *b_vbf_AK4_j2_pt;   //!

   TBranch        *b_vbf_AK4_j2_eta;   //!

   TBranch        *b_vbf_AK4_j2_phi;   //!

   TBranch        *b_vbf_AK4_j2_e;   //!

   TBranch        *b_vbf_AK4_j2_bDiscriminatorCSV;   //!

   TBranch        *b_vbf_AK4_jj_pt;   //!

   TBranch        *b_vbf_AK4_jj_eta;   //!

   TBranch        *b_vbf_AK4_jj_phi;   //!

   TBranch        *b_vbf_AK4_jj_m;   //!

   TBranch        *b_vbf_AK4_jj_DeltaEta;   //!

   TBranch        *b_Wjets_AK4_j1_pt;   //!

   TBranch        *b_Wjets_AK4_j1_eta;   //!

   TBranch        *b_Wjets_AK4_j1_phi;   //!

   TBranch        *b_Wjets_AK4_j1_e;   //!

   TBranch        *b_Wjets_AK4_j1_bDiscriminatorCSV;   //!

   TBranch        *b_Wjets_AK4_j2_pt;   //!

   TBranch        *b_Wjets_AK4_j2_eta;   //!

   TBranch        *b_Wjets_AK4_j2_phi;   //!

   TBranch        *b_Wjets_AK4_j2_e;   //!

   TBranch        *b_Wjets_AK4_j2_bDiscriminatorCSV;   //!

   TBranch        *b_Wjets_AK4_jj_pt;   //!

   TBranch        *b_Wjets_AK4_jj_eta;   //!

   TBranch        *b_Wjets_AK4_jj_phi;   //!

   TBranch        *b_Wjets_AK4_jj_m;   //!

   TBranch        *b_Wjets_AK4_jj_e;   //!
...

{
   ...
   fChain->SetBranchAddress("njetsAK4", &njetsAK4, &b_njetsAK4);
   ...
   fChain->SetBranchAddress("vbf_AK4_j1_pt", &vbf_AK4_j1_pt, &b_vbf_AK4_j1_pt);

   fChain->SetBranchAddress("vbf_AK4_j1_eta", &vbf_AK4_j1_eta, &b_vbf_AK4_j1_eta);

   fChain->SetBranchAddress("vbf_AK4_j1_phi", &vbf_AK4_j1_phi, &b_vbf_AK4_j1_phi);

   fChain->SetBranchAddress("vbf_AK4_j1_e", &vbf_AK4_j1_e, &b_vbf_AK4_j1_e);

   fChain->SetBranchAddress("vbf_AK4_j1_bDiscriminatorCSV", &vbf_AK4_j1_bDiscriminatorCSV, &b_vbf_AK4_j1_bDiscriminatorCSV);

   fChain->SetBranchAddress("vbf_AK4_j2_pt", &vbf_AK4_j2_pt, &b_vbf_AK4_j2_pt);

   fChain->SetBranchAddress("vbf_AK4_j2_eta", &vbf_AK4_j2_eta, &b_vbf_AK4_j2_eta);

   fChain->SetBranchAddress("vbf_AK4_j2_phi", &vbf_AK4_j2_phi, &b_vbf_AK4_j2_phi);

   fChain->SetBranchAddress("vbf_AK4_j2_e", &vbf_AK4_j2_e, &b_vbf_AK4_j2_e);

   fChain->SetBranchAddress("vbf_AK4_j2_bDiscriminatorCSV", &vbf_AK4_j2_bDiscriminatorCSV, &b_vbf_AK4_j2_bDiscriminatorCSV);

   fChain->SetBranchAddress("vbf_AK4_jj_pt", &vbf_AK4_jj_pt, &b_vbf_AK4_jj_pt);

   fChain->SetBranchAddress("vbf_AK4_jj_eta", &vbf_AK4_jj_eta, &b_vbf_AK4_jj_eta);

   fChain->SetBranchAddress("vbf_AK4_jj_phi", &vbf_AK4_jj_phi, &b_vbf_AK4_jj_phi);

   fChain->SetBranchAddress("vbf_AK4_jj_m", &vbf_AK4_jj_m, &b_vbf_AK4_jj_m);

   fChain->SetBranchAddress("vbf_AK4_jj_DeltaEta", &vbf_AK4_jj_DeltaEta, &b_vbf_AK4_jj_DeltaEta);

   fChain->SetBranchAddress("Wjets_AK4_j1_pt", &Wjets_AK4_j1_pt, &b_Wjets_AK4_j1_pt);

   fChain->SetBranchAddress("Wjets_AK4_j1_eta", &Wjets_AK4_j1_eta, &b_Wjets_AK4_j1_eta);

   fChain->SetBranchAddress("Wjets_AK4_j1_phi", &Wjets_AK4_j1_phi, &b_Wjets_AK4_j1_phi);

   fChain->SetBranchAddress("Wjets_AK4_j1_e", &Wjets_AK4_j1_e, &b_Wjets_AK4_j1_e);

   fChain->SetBranchAddress("Wjets_AK4_j1_bDiscriminatorCSV", &Wjets_AK4_j1_bDiscriminatorCSV, &b_Wjets_AK4_j1_bDiscriminatorCSV);

   fChain->SetBranchAddress("Wjets_AK4_j2_pt", &Wjets_AK4_j2_pt, &b_Wjets_AK4_j2_pt);

   fChain->SetBranchAddress("Wjets_AK4_j2_eta", &Wjets_AK4_j2_eta, &b_Wjets_AK4_j2_eta);

   fChain->SetBranchAddress("Wjets_AK4_j2_phi", &Wjets_AK4_j2_phi, &b_Wjets_AK4_j2_phi);

   fChain->SetBranchAddress("Wjets_AK4_j2_e", &Wjets_AK4_j2_e, &b_Wjets_AK4_j2_e);

   fChain->SetBranchAddress("Wjets_AK4_j2_bDiscriminatorCSV", &Wjets_AK4_j2_bDiscriminatorCSV, &b_Wjets_AK4_j2_bDiscriminatorCSV);

   fChain->SetBranchAddress("Wjets_AK4_jj_pt", &Wjets_AK4_jj_pt, &b_Wjets_AK4_jj_pt);

   fChain->SetBranchAddress("Wjets_AK4_jj_eta", &Wjets_AK4_jj_eta, &b_Wjets_AK4_jj_eta);

   fChain->SetBranchAddress("Wjets_AK4_jj_phi", &Wjets_AK4_jj_phi, &b_Wjets_AK4_jj_phi);

   fChain->SetBranchAddress("Wjets_AK4_jj_m", &Wjets_AK4_jj_m, &b_Wjets_AK4_jj_m);

   fChain->SetBranchAddress("Wjets_AK4_jj_e", &Wjets_AK4_jj_e, &b_Wjets_AK4_jj_e);
